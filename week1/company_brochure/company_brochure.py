...
def get_links_user_prompt(website):
    user_prompt = "Here is the list of links on the website of {website.url} - "
...
def get_all_details(url):
    ...
    links = get_links(url)  #json.loads('{"links": [{"type": "about page", "url": "https://buupass.com/about-us.html"},{"type": "blog page", "url": "https://blog.buupass.com/"}]}')
